...
const KakaoLoginButton = ({ KAKAO_REST_API_KEY, KAKAO_REDIRECT_URI }) => {
  const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=d1561b312e7d598361f42f47d8baf198&redirect_uri=http://www.aiunailit.com/oauth/callback/kakao&scope=profile_nickname`;
